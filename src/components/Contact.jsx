        ...
        {loaded && currentFrameIdx >= 120 && (
          ...
          >
            <div className="text-center mb-6">
              ...
              <div className="flex items-center justify-center space-x-2 text-cyan-500/60 font-mono text-[9px] tracking-[0.6em] uppercase mb-2">
                <FiShield />
                <span>Protocol: Neural_Gate</span>
              </div>
              <a 
                href="mailto:bharathg98765@gmail.com" 
                className="inline-block text-cyan-400 hover:text-white font-mono text-xs tracking-widest transition-colors border-b border-cyan-500/30 pb-0.5"
              >
